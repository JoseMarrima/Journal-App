...
public class MainActivity extends AppCompatActivity implements JournalAdapter.ItemClickListener {
    ...
    // Member variables for the RecyclerView
            ...
            public void onSwiped(final RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                AppExecutors.getInstance().diskIO().execute(new Runnable() {
                    ...
                    public void run() {
                        ...
                        List<JournalEntry> tasks = mJournalAdapter.getJournals();
                        mAppDatabase.journalDao().deleteTask(tasks.get(position));
                    }
                });
            }
    ...
    private void setupViewModel() {
        ...
        viewModel.getJournals().observe(this, new Observer<List<JournalEntry>>() {
            ...
            public void onChanged(@Nullable List<JournalEntry> journalEntries) {
                ...
                mJournalAdapter.setTasks(journalEntries);
            }
        });
    }
